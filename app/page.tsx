...
export default function Home() {
  ...
  function addEntry(food: Food, servings = 1) {
    ...
    setNotice(`${food.name} added to ${readableDate(selectedDate)}.`);
  }
  ...
  function createFood(logImmediately: boolean) {
    ...
    setFoodQuery("");
    setNotice(logImmediately ? `${food.name} saved and logged.` : `${food.name} saved.`);
  ...
  function clearDay() {
    ...
    setNotice(`${readableDate(selectedDate)} cleared.`);
  }
  ...
  return (
    <main className="app-shell">
      <header className="app-header">
        <div>
          <p className="kicker">Local-first macro tracker</p>
        ...
        {MACRO_FIELDS.map((field) => {
          ...
          return (
            <article className="total-tile" key={field.key}>
              ...
              <small>
                {target > 0
                  ? `${cleanNumber(Math.max(target - total, 0))}${field.unit} left`
                  : "No target"}
              </small>
            </article>
          );
        ...
        <section className="panel day-log" aria-labelledby="day-log-title">
          <div className="panel-heading">
            <div>
              ...
              <h2 id="day-log-title">{readableDate(selectedDate)}</h2>
            </div>
            <button
              ...
              dailyEntries.map((entry) => (
                <article className="entry-row" key={entry.id}>
                  <div className="entry-food">
                    ...
                    <span>
                      {cleanNumber(entry.calories)} cal per serving
                    </span>
                  </div>
        ...
        <aside className="side-stack">
          <section className="panel" aria-labelledby="new-food-title">
            <div className="panel-heading compact">
              <div>
                <p className="eyebrow">Saved food</p>
          ...
          <section className="panel" aria-labelledby="targets-title">
            <div className="panel-heading compact">
              <div>
      ...
      <div className="workspace-grid lower-grid">
        <section className="panel food-library" aria-labelledby="library-title">
          <div className="panel-heading">
            <div>
              <p className="eyebrow">Reusable foods</p>
              <h2 id="library-title">Food Library</h2>
            </div>
